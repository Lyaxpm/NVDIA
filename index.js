...
const { default: makeWASocket, useMultiFileAuthState } = require('@whiskeynvdiaets/baileys');
...
const startConnection = async () => {
    ...
    /*
    * Seperti yang gua bilang tadi,
    * menggunakan module.exports.handlecomingMessage 
    * Disini lah menangani pesan terbaru yang muncul
    */
